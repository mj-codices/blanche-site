...
export default function ServicesPage() {
  return (
    <div className="mx-5 flex flex-col items-start justify-center space-y-4 pl-2 sm:space-y-6 sm:pr-5 sm:pl-8 md:mx-0 md:flex-row md:items-baseline md:space-x-8 md:pt-15 md:pl-0 lg:space-x-12">
