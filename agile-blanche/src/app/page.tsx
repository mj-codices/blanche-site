...
export default function Home() {
  return (
    ...
    <section className="flex items-center justify-center">
      <div className="pt-2 sm:pt-8 md:pt-10 lg:pt-15">
    ...
    <section className="flex items-center justify-center">
      <div className="pt-6">
        ...
        <div className="flex items-center justify-center">
            <Button className="rounded-full bg-[#171717] font-[myFirstFont] text-lg text-white pl-3.5 pr-3.5 pb-3 pt-3.5 mt-1 sm:mt-10">Contact Us</Button>
        </div>
      </div>
    </section>
    </div>
