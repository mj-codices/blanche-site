  ...
  return (
    <div className="inset-0">
      <div className="mb-5 flex justify-center shadow-lg md:pl-10">
        <span className="pl-6 sm:pl-2 md:pl-0 mb-5 text-center text-lg tracking-[1.7rem] uppercase sm:text-xl md:text-2xl lg:text-3xl">
          Portfolio
        </span>
      </div>
      <div className="pt-5 sm:pt-8 lg:pt-12">
        <h1 className="text-center font-[myFirstFontBold] text-4xl sm:text-5xl tracking-[.3rem] sm:tracking-[.5rem] md:tracking-[.3rem] md:pl-2 md:text-6xl lg:pl-4 lg:text-7xl lg:tracking-[.5rem]">
          Coming Soon.
        </h1>
      </div>
